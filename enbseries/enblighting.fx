...
texture2D texMoon < string ResourceName="v_moon.png"; >;
texture2D texNs < string ResourceName="Noise.png"; >;
texture2D texNs2 < string ResourceName="No_texture.png";>;
texture2D texPd < string ResourceName="v_puddle.png"; >;
...
if (wx.x==0,1) cc = float3(0.368, 0.50, 1.0);
if (wx.y==0,1) cn = float3(0.368, 0.50, 1.0);

float3 skyW = float3(0.100, 0.100, 0.100);
